...
`)+`
`+p);const M=A+m+o,T=A+p+a,U=Mf(r,r.VERTEX_SHADER,M),P=Mf(r,r.FRAGMENT_SHADER,T);r.attachShader(v,U),r.attachShader(v,P),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function w(D){if(i.debug.checkShaderErrors){const q=r.getProgramInfoLog(v).trim(),H=r.getShaderInfoLog(U).trim(),ee=r.getShaderInfoLog(P).trim();let te=!0,Z=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(te=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,v,U,P);else{const Q=yf(r,U,"vertex"),j=yf(r,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
}`;function Ky(i,e,t){let n=new Oc;const r=new Ie,s=new Ie,o=new ot,a=new Xy({depthPacking:R_}),l=new jy,c={},u=t.maxTextureSize,f={[Jn]:jt,[jt]:Jn,[An]:An},h=new Ei({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ie},radius:{value:4}},vertexShader:qy,fragmentShader:Yy}),d=h.clone();d.defines.HORIZONTAL_PASS=1;const g=new Nn;g.setAttribute("position",new Gt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Qt(g,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=nd;let p=this.type;this.render=function(P,w,F){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||P.length===0)return;const b=i.getRenderTarget(),S=i.getActiveCubeFace(),D=i.getActiveMipmapLevel(),q=i.state;q.setBlending(xi),q.buffers.color.setClear(1,1,1,1),q.buffers.depth.setTest(!0),q.setScissorTest(!1);const H=p!==Wn&&this.type===Wn,ee=p===Wn&&this.type!==Wn;for(let te=0,Z=P.length;te<Z;te++){const Q=P[te],j=Q.shadow;if(j===void 0){console.warn("THREE.WebGLShadowMap:",Q,"has no shadow.");continue}if(j.autoUpdate===!1&&j.needsUpdate===!1)continue;r.copy(j.mapSize);const de=j.getFrameExtents();if(r.multiply(de),s.copy(j.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/de.x),r.x=s.x*de.x,j.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/de.y),r.y=s.y*de.y,j.mapSize.y=s.y)),j.map===null||H===!0||ee===!0){const ye=this.type!==Wn?{minFilter:Vt,magFilter:Vt}:{};j.map!==null&&j.map.dispose(),j.map=new qi(r.x,r.y,ye),j.map.texture.name=Q.name+".shadowMap",j.camera.updateProjectionMatrix()}i.setRenderTarget(j.map),i.clear();const _e=j.getViewportCount();for(let ye=0;ye<_e;ye++){const Be=j.getViewport(ye);o.set(s.x*Be.x,s.y*Be.y,s.x*Be.z,s.y*Be.w),q.viewport(o),j.updateMatrices(Q,ye),n=j.getFrustum(),T(w,F,j.camera,Q,this.type)}j.isPointLightShadow!==!0&&this.type===Wn&&A(j,F),j.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(b,S,D)};function A(P,w){const F=e.update(v);h.defines.VSM_SAMPLES!==P.blurSamples&&(h.defines.VSM_SAMPLES=P.blurSamples,d.defines.VSM_SAMPLES=P.blurSamples,h.needsUpdate=!0,d.needsUpdate=!0),P.mapPass===null&&(P.mapPass=new qi(r.x,r.y)),h.uniforms.shadow_pass.value=P.map.texture,h.uniforms.resolution.value=P.mapSize,h.uniforms.radius.value=P.radius,i.setRenderTarget(P.mapPass),i.clear(),i.renderBufferDirect(w,null,F,h,v,null),d.uniforms.shadow_pass.value=P.mapPass.texture,d.uniforms.resolution.value=P.mapSize,d.uniforms.radius.value=P.radius,i.setRenderTarget(P.map),i.clear(),i.renderBufferDirect(w,null,F,d,v,null)}function M(P,w,F,b){let S=null;const D=F.isPointLight===!0?P.customDistanceMaterial:P.customDepthMaterial;if(D!==void 0)S=D;else if(S=F.isPointLight===!0?l:a,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const q=S.uuid,H=w.uuid;let ee=c[q];ee===void 0&&(ee={},c[q]=ee);let te=ee[H];te===void 0&&(te=S.clone(),ee[H]=te,w.addEventListener("dispose",U)),S=te}if(S.visible=w.visible,S.wireframe=w.wireframe,b===Wn?S.side=w.shadowSide!==null?w.shadowSide:w.side:S.side=w.shadowSide!==null?w.shadowSide:f[w.side],S.alphaMap=w.alphaMap,S.alphaTest=w.alphaTest,S.map=w.map,S.clipShadows=w.clipShadows,S.clippingPlanes=w.clippingPlanes,S.clipIntersection=w.clipIntersection,S.displacementMap=w.displacementMap,S.displacementScale=w.displacementScale,S.displacementBias=w.displacementBias,S.wireframeLinewidth=w.wireframeLinewidth,S.linewidth=w.linewidth,F.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const q=i.properties.get(S);q.light=F}return S}function T(P,w,F,b,S){if(P.visible===!1)return;if(P.layers.test(w.layers)&&(P.isMesh||P.isLine||P.isPoints)&&(P.castShadow||P.receiveShadow&&S===Wn)&&(!P.frustumCulled||n.intersectsObject(P))){P.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,P.matrixWorld);const H=e.update(P),ee=P.material;if(Array.isArray(ee)){const te=H.groups;for(let Z=0,Q=te.length;Z<Q;Z++){const j=te[Z],de=ee[j.materialIndex];if(de&&de.visible){const _e=M(P,de,b,S);P.onBeforeShadow(i,P,w,F,H,_e,j),i.renderBufferDirect(F,null,H,_e,P,j),P.onAfterShadow(i,P,w,F,H,_e,j)}}}else if(ee.visible){const te=M(P,ee,b,S);P.onBeforeShadow(i,P,w,F,H,te,null),i.renderBufferDirect(F,null,H,te,P,null),P.onAfterShadow(i,P,w,F,H,te,null)}}const q=P.children;for(let H=0,ee=q.length;H<ee;H++)T(q[H],w,F,b,S)}function U(P){P.target.removeEventListener("dispose",U);for(const F in c){const b=c[F],S=P.target.uuid;S in b&&(b[S].dispose(),delete b[S])}}}function $y(i){function e(){let x=!1;const W=new ot;let Y=null;const J=new ot(0,0,0,0);return{setMask:function(ue){Y!==ue&&!x&&(i.colorMask(ue,ue,ue,ue),Y=ue)},setLocked:function(ue){x=ue},setClear:function(ue,Ae,Ue,dt,_t){_t===!0&&(ue*=dt,Ae*=dt,Ue*=dt),W.set(ue,Ae,Ue,dt),J.equals(W)===!1&&(i.clearColor(ue,Ae,Ue,dt),J.copy(W))},reset:function(){x=!1,Y=null,J.set(-1,0,0,0)}}}function t(){let x=!1,W=null,Y=null,J=null;return{setTest:function(ue){ue?Se(i.DEPTH_TEST):me(i.DEPTH_TEST)},setMask:function(ue){W!==ue&&!x&&(i.depthMask(ue),W=ue)},setFunc:function(ue){if(Y!==ue){switch(ue){case l_:i.depthFunc(i.NEVER);break;case c_:i.depthFunc(i.ALWAYS);break;case u_:i.depthFunc(i.LESS);break;case Fo:i.depthFunc(i.LEQUAL);break;case f_:i.depthFunc(i.EQUAL);break;case h_:i.depthFunc(i.GEQUAL);break;case d_:i.depthFunc(i.GREATER);break;case p_:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Y=ue}},setLocked:function(ue){x=ue},setClear:function(ue){J!==ue&&(i.clearDepth(ue),J=ue)},reset:function(){x=!1,W=null,Y=null,J=null}}}function n(){let x=!1,W=null,Y=null,J=null,ue=null,Ae=null,Ue=null,dt=null,_t=null;return{setTest:function($e){x||($e?Se(i.STENCIL_TEST):me(i.STENCIL_TEST))},setMask:function($e){W!==$e&&!x&&(i.stencilMask($e),W=$e)},setFunc:function($e,vt,pt){(Y!==$e||J!==vt||ue!==pt)&&(i.stencilFunc($e,vt,pt),Y=$e,J=vt,ue=pt)},setOp:function($e,vt,pt){(Ae!==$e||Ue!==vt||dt!==pt)&&(i.stencilOp($e,vt,pt),Ae=$e,Ue=vt,dt=pt)},setLocked:function($e){x=$e},setClear:function($e){_t!==$e&&(i.clearStencil($e),_t=$e)},reset:function(){x=!1,W=null,Y=null,J=null,ue=null,Ae=null,Ue=null,dt=null,_t=null}}}const r=new e,s=new t,o=new n,a=new WeakMap,l=new WeakMap;let c={},u={},f=new WeakMap,h=[],d=null,g=!1,v=null,m=null,p=null,A=null,M=null,T=null,U=null,P=new ke(0,0,0),w=0,F=!1,b=null,S=null,D=null,q=null,H=null;const ee=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let te=!1,Z=0;const Q=i.getParameter(i.VERSION);Q.indexOf("WebGL")!==-1?(Z=parseFloat(/^WebGL (\d)/.exec(Q)[1]),te=Z>=1):Q.indexOf("OpenGL ES")!==-1&&(Z=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),te=Z>=2);let j=null,de={};const _e=i.getParameter(i.SCISSOR_BOX),ye=i.getParameter(i.VIEWPORT),Be=new ot().fromArray(_e),Ge=new ot().fromArray(ye);function re(x,W,Y,J){const ue=new Uint8Array(4),Ae=i.createTexture();i.bindTexture(x,Ae),i.texParameteri(x,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(x,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ue=0;Ue<Y;Ue++)x===i.TEXTURE_3D||x===i.TEXTURE_2D_ARRAY?i.texImage3D(W,0,i.RGBA,1,1,J,0,i.RGBA,i.UNSIGNED_BYTE,ue):i.texImage2D(W+Ue,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ue);return Ae}const fe={};fe[i.TEXTURE_2D]=re(i.TEXTURE_2D,i.TEXTURE_2D,1),fe[i.TEXTURE_CUBE_MAP]=re(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),fe[i.TEXTURE_2D_ARRAY]=re(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),fe[i.TEXTURE_3D]=re(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),o.setClear(0),Se(i.DEPTH_TEST),s.setFunc(Fo),V(!1),z(Cu),Se(i.CULL_FACE),R(xi);function Se(x){c[x]!==!0&&(i.enable(x),c[x]=!0)}function me(x){c[x]!==!1&&(i.disable(x),c[x]=!1)}function Le(x,W){return u[x]!==W?(i.bindFramebuffer(x,W),u[x]=W,x===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=W),x===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=W),!0):!1}function Fe(x,W){let Y=h,J=!1;if(x){Y=f.get(W),Y===void 0&&(Y=[],f.set(W,Y));const ue=x.textures;if(Y.length!==ue.length||Y[0]!==i.COLOR_ATTACHMENT0){for(let Ae=0,Ue=ue.length;Ae<Ue;Ae++)Y[Ae]=i.COLOR_ATTACHMENT0+Ae;Y.length=ue.length,J=!0}}else Y[0]!==i.BACK&&(Y[0]=i.BACK,J=!0);J&&i.drawBuffers(Y)}function Ne(x){return d!==x?(i.useProgram(x),d=x,!0):!1}const nt={[Bi]:i.FUNC_ADD,[Xg]:i.FUNC_SUBTRACT,[jg]:i.FUNC_REVERSE_SUBTRACT};nt[qg]=i.MIN,nt[Yg]=i.MAX;const L={[Kg]:i.ZERO,[$g]:i.ONE,[Zg]:i.SRC_COLOR,[xl]:i.SRC_ALPHA,[i_]:i.SRC_ALPHA_SATURATE,[t_]:i.DST_COLOR,[Qg]:i.DST_ALPHA,[Jg]:i.ONE_MINUS_SRC_COLOR,[Ml]:i.ONE_MINUS_SRC_ALPHA,[n_]:i.ONE_MINUS_DST_COLOR,[e_]:i.ONE_MINUS_DST_ALPHA,[r_]:i.CONSTANT_COLOR,[s_]:i.ONE_MINUS_CONSTANT_COLOR,[o_]:i.CONSTANT_ALPHA,[a_]:i.ONE_MINUS_CONSTANT_ALPHA};function R(x,W,Y,J,ue,Ae,Ue,dt,_t,$e){if(x===xi){g===!0&&(me(i.BLEND),g=!1);return}if(g===!1&&(Se(i.BLEND),g=!0),x!==Wg){if(x!==v||$e!==F){if((m!==Bi||M!==Bi)&&(i.blendEquation(i.FUNC_ADD),m=Bi,M=Bi),$e)switch(x){case Rr:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Pu:i.blendFunc(i.ONE,i.ONE);break;case Lu:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Iu:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",x);break}else switch(x){case Rr:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Pu:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Lu:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Iu:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",x);break}p=null,A=null,T=null,U=null,P.set(0,0,0),w=0,v=x,F=$e}return}ue=ue||W,Ae=Ae||Y,Ue=Ue||J,(W!==m||ue!==M)&&(i.blendEquationSeparate(nt[W],nt[ue]),m=W,M=ue),(Y!==p||J!==A||Ae!==T||Ue!==U)&&(i.blendFuncSeparate(L[Y],L[J],L[Ae],L[Ue]),p=Y,A=J,T=Ae,U=Ue),(dt.equals(P)===!1||_t!==w)&&(i.blendColor(dt.r,dt.g,dt.b,_t),P.copy(dt),w=_t),v=x,F=!1}function I(x,W){x.side===An?me(i.CULL_FACE):Se(i.CULL_FACE);let Y=x.side===jt;W&&(Y=!Y),V(Y),x.blending===Rr&&x.transparent===!1?R(xi):R(x.blending,x.blendEquation,x.blendSrc,x.blendDst,x.blendEquationAlpha,x.blendSrcAlpha,x.blendDstAlpha,x.blendColor,x.blendAlpha,x.premultipliedAlpha),s.setFunc(x.depthFunc),s.setTest(x.depthTest),s.setMask(x.depthWrite),r.setMask(x.colorWrite);const J=x.stencilWrite;o.setTest(J),J&&(o.setMask(x.stencilWriteMask),o.setFunc(x.stencilFunc,x.stencilRef,x.stencilFuncMask),o.setOp(x.stencilFail,x.stencilZFail,x.stencilZPass)),ne(x.polygonOffset,x.polygonOffsetFactor,x.polygonOffsetUnits),x.alphaToCoverage===!0?Se(i.SAMPLE_ALPHA_TO_COVERAGE):me(i.SAMPLE_ALPHA_TO_COVERAGE)}function V(x){b!==x&&(x?i.frontFace(i.CW):i.frontFace(i.CCW),b=x)}function z(x){x!==Hg?(Se(i.CULL_FACE),x!==S&&(x===Cu?i.cullFace(i.BACK):x===Vg?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):me(i.CULL_FACE),S=x}function ie(x){x!==D&&(te&&i.lineWidth(x),D=x)}function ne(x,W,Y){x?(Se(i.POLYGON_OFFSET_FILL),(q!==W||H!==Y)&&(i.polygonOffset(W,Y),q=W,H=Y)):me(i.POLYGON_OFFSET_FILL)}function se(x){x?Se(i.SCISSOR_TEST):me(i.SCISSOR_TEST)}function y(x){x===void 0&&(x=i.TEXTURE0+ee-1),j!==x&&(i.activeTexture(x),j=x)}function _(x,W,Y){Y===void 0&&(j===null?Y=i.TEXTURE0+ee-1:Y=j);let J=de[Y];J===void 0&&(J={type:void 0,texture:void 0},de[Y]=J),(J.type!==x||J.texture!==W)&&(j!==Y&&(i.activeTexture(Y),j=Y),i.bindTexture(x,W||fe[x]),J.type=x,J.texture=W)}function C(){const x=de[j];x!==void 0&&x.type!==void 0&&(i.bindTexture(x.type,null),x.type=void 0,x.texture=void 0)}function X(){try{i.compressedTexImage2D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function G(){try{i.compressedTexImage3D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function k(){try{i.texSubImage2D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function le(){try{i.texSubImage3D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function ae(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function ce(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function ve(){try{i.texStorage2D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function oe(){try{i.texStorage3D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function pe(){try{i.texImage2D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function ze(){try{i.texImage3D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function Re(x){Be.equals(x)===!1&&(i.scissor(x.x,x.y,x.z,x.w),Be.copy(x))}function xe(x){Ge.equals(x)===!1&&(i.viewport(x.x,x.y,x.z,x.w),Ge.copy(x))}function Pe(x,W){let Y=l.get(W);Y===void 0&&(Y=new WeakMap,l.set(W,Y));let J=Y.get(x);J===void 0&&(J=i.getUniformBlockIndex(W,x.name),Y.set(x,J))}function be(x,W){const J=l.get(W).get(x);a.get(W)!==J&&(i.uniformBlockBinding(W,J,x.__bindingPointIndex),a.set(W,J))}function Ye(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),c={},j=null,de={},u={},f=new WeakMap,h=[],d=null,g=!1,v=null,m=null,p=null,A=null,M=null,T=null,U=null,P=new ke(0,0,0),w=0,F=!1,b=null,S=null,D=null,q=null,H=null,Be.set(0,0,i.canvas.width,i.canvas.height),Ge.set(0,0,i.canvas.width,i.canvas.height),r.reset(),s.reset(),o.reset()}return{buffers:{color:r,depth:s,stencil:o},enable:Se,disable:me,bindFramebuffer:Le,drawBuffers:Fe,useProgram:Ne,setBlending:R,setMaterial:I,setFlipSided:V,setCullFace:z,setLineWidth:ie,setPolygonOffset:ne,setScissorTest:se,activeTexture:y,bindTexture:_,unbindTexture:C,compressedTexImage2D:X,compressedTexImage3D:G,texImage2D:pe,texImage3D:ze,updateUBOMapping:Pe,uniformBlockBinding:be,texStorage2D:ve,texStorage3D:oe,texSubImage2D:k,texSubImage3D:le,compressedTexSubImage2D:ae,compressedTexSubImage3D:ce,scissor:Re,viewport:xe,reset:Ye}}function Cf(i,e,t,n){const r=Zy(n);switch(t){case cd:return i*e;case fd:return i*e;case hd:return i*e*2;case Pc:return i*e/r.components*r.byteLength;case Lc:return i*e/r.components*r.byteLength;case dd:return i*e*2/r.components*r.byteLength;case Ic:return i*e*2/r.components*r.byteLength;case ud:return i*e*3/r.components*r.byteLength;case sn:return i*e*4/r.components*r.byteLength;case Dc:return i*e*4/r.components*r.byteLength;case To:case bo:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Ao:case wo:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Tl:case Al:return Math.max(i,16)*Math.max(e,8)/4;case El:case bl:return Math.max(i,8)*Math.max(e,8)/2;case wl:case Rl:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Cl:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Pl:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Ll:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case Il:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case Dl:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case Nl:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case Ul:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case Ol:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case Fl:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case Bl:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case zl:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case kl:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case Hl:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case Vl:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case Gl:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case Ro:case Wl:case Xl:return Math.ceil(i/4)*Math.ceil(e/4)*16;case pd:case jl:return Math.ceil(i/4)*Math.ceil(e/4)*8;case ql:case Yl:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function Zy(i){switch(i){case Qn:case od:return{byteLength:1,components:1};case Cs:case ad:case Ns:return{byteLength:2,components:1};case Rc:case Cc:return{byteLength:2,components:4};case ji:case wc:case mn:return{byteLength:4,components:1};case ld:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function Jy(i,e,t,n,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ie,u=new WeakMap;let f;const h=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(y,_){return d?new OffscreenCanvas(y,_):Is("canvas")}function v(y,_,C){let X=1;const G=se(y);if((G.width>C||G.height>C)&&(X=C/Math.max(G.width,G.height)),X<1)if(typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&y instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&y instanceof ImageBitmap||typeof VideoFrame<"u"&&y instanceof VideoFrame){const k=Math.floor(X*G.width),le=Math.floor(X*G.height);f===void 0&&(f=g(k,le));const ae=_?g(k,le):f;return ae.width=k,ae.height=le,ae.getContext("2d").drawImage(y,0,0,k,le),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+G.width+"x"+G.height+") to ("+k+"x"+le+")."),ae}else return"data"in y&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+G.width+"x"+G.height+")."),y;return y}function m(y){return y.generateMipmaps&&y.minFilter!==Vt&&y.minFilter!==Jt}function p(y){i.generateMipmap(y)}function A(y,_,C,X,G=!1){if(y!==null){if(i[y]!==void 0)return i[y];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+y+"'")}let k=_;if(_===i.RED&&(C===i.FLOAT&&(k=i.R32F),C===i.HALF_FLOAT&&(k=i.R16F),C===i.UNSIGNED_BYTE&&(k=i.R8)),_===i.RED_INTEGER&&(C===i.UNSIGNED_BYTE&&(k=i.R8UI),C===i.UNSIGNED_SHORT&&(k=i.R16UI),C===i.UNSIGNED_INT&&(k=i.R32UI),C===i.BYTE&&(k=i.R8I),C===i.SHORT&&(k=i.R16I),C===i.INT&&(k=i.R32I)),_===i.RG&&(C===i.FLOAT&&(k=i.RG32F),C===i.HALF_FLOAT&&(k=i.RG16F),C===i.UNSIGNED_BYTE&&(k=i.RG8)),_===i.RG_INTEGER&&(C===i.UNSIGNED_BYTE&&(k=i.RG8UI),C===i.UNSIGNED_SHORT&&(k=i.RG16UI),C===i.UNSIGNED_INT&&(k=i.RG32UI),C===i.BYTE&&(k=i.RG8I),C===i.SHORT&&(k=i.RG16I),C===i.INT&&(k=i.RG32I)),_===i.RGB&&C===i.UNSIGNED_INT_5_9_9_9_REV&&(k=i.RGB9_E5),_===i.RGBA){const le=G?zo:Ze.getTransfer(X);C===i.FLOAT&&(k=i.RGBA32F),C===i.HALF_FLOAT&&(k=i.RGBA16F),C===i.UNSIGNED_BYTE&&(k=le===lt?i.SRGB8_ALPHA8:i.RGBA8),C===i.UNSIGNED_SHORT_4_4_4_4&&(k=i.RGBA4),C===i.UNSIGNED_SHORT_5_5_5_1&&(k=i.RGB5_A1)}return(k===i.R16F||k===i.R32F||k===i.RG16F||k===i.RG32F||k===i.RGBA16F||k===i.RGBA32F)&&e.get("EXT_color_buffer_float"),k}function M(y,_){let C;return y?_===null||_===ji||_===zr?C=i.DEPTH24_STENCIL8:_===mn?C=i.DEPTH32F_STENCIL8:_===Cs&&(C=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===ji||_===zr?C=i.DEPTH_COMPONENT24:_===mn?C=i.DEPTH_COMPONENT32F:_===Cs&&(C=i.DEPTH_COMPONENT16),C}function T(y,_){return m(y)===!0||y.isFramebufferTexture&&y.minFilter!==Vt&&y.minFilter!==Jt?Math.log2(Math.max(_.width,_.height))+1:y.mipmaps!==void 0&&y.mipmaps.length>0?y.mipmaps.length:y.isCompressedTexture&&Array.isArray(y.image)?_.mipmaps.length:1}function U(y){const _=y.target;_.removeEventListener("dispose",U),w(_),_.isVideoTexture&&u.delete(_)}function P(y){const _=y.target;_.removeEventListener("dispose",P),b(_)}function w(y){const _=n.get(y);if(_.__webglInit===void 0)return;const C=y.source,X=h.get(C);if(X){const G=X[_.__cacheKey];G.usedTimes--,G.usedTimes===0&&F(y),Object.keys(X).length===0&&h.delete(C)}n.remove(y)}function F(y){const _=n.get(y);i.deleteTexture(_.__webglTexture);const C=y.source,X=h.get(C);delete X[_.__cacheKey],o.memory.textures--}function b(y){const _=n.get(y);if(y.depthTexture&&y.depthTexture.dispose(),y.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(_.__webglFramebuffer[X]))for(let G=0;G<_.__webglFramebuffer[X].length;G++)i.deleteFramebuffer(_.__webglFramebuffer[X][G]);else i.deleteFramebuffer(_.__webglFramebuffer[X]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[X])}else{if(Array.isArray(_.__webglFramebuffer))for(let X=0;X<_.__webglFramebuffer.length;X++)i.deleteFramebuffer(_.__webglFramebuffer[X]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let X=0;X<_.__webglColorRenderbuffer.length;X++)_.__webglColorRenderbuffer[X]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[X]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const C=y.textures;for(let X=0,G=C.length;X<G;X++){const k=n.get(C[X]);k.__webglTexture&&(i.deleteTexture(k.__webglTexture),o.memory.textures--),n.remove(C[X])}n.remove(y)}let S=0;function D(){S=0}function q(){const y=S;return y>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+y+" texture units while this GPU supports only "+r.maxTextures),S+=1,y}function H(y){const _=[];return _.push(y.wrapS),_.push(y.wrapT),_.push(y.wrapR||0),_.push(y.magFilter),_.push(y.minFilter),_.push(y.anisotropy),_.push(y.internalFormat),_.push(y.format),_.push(y.type),_.push(y.generateMipmaps),_.push(y.premultiplyAlpha),_.push(y.flipY),_.push(y.unpackAlignment),_.push(y.colorSpace),_.join()}function ee(y,_){const C=n.get(y);if(y.isVideoTexture&&ie(y),y.isRenderTargetTexture===!1&&y.version>0&&C.__version!==y.version){const X=y.image;if(X===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Ge(C,y,_);return}}t.bindTexture(i.TEXTURE_2D,C.__webglTexture,i.TEXTURE0+_)}function te(y,_){const C=n.get(y);if(y.version>0&&C.__version!==y.version){Ge(C,y,_);return}t.bindTexture(i.TEXTURE_2D_ARRAY,C.__webglTexture,i.TEXTURE0+_)}function Z(y,_){const C=n.get(y);if(y.version>0&&C.__version!==y.version){Ge(C,y,_);return}t.bindTexture(i.TEXTURE_3D,C.__webglTexture,i.TEXTURE0+_)}function Q(y,_){const C=n.get(y);if(y.version>0&&C.__version!==y.version){re(C,y,_);return}t.bindTexture(i.TEXTURE_CUBE_MAP,C.__webglTexture,i.TEXTURE0+_)}const j={[Br]:i.REPEAT,[mi]:i.CLAMP_TO_EDGE,[Bo]:i.MIRRORED_REPEAT},de={[Vt]:i.NEAREST,[sd]:i.NEAREST_MIPMAP_NEAREST,[ms]:i.NEAREST_MIPMAP_LINEAR,[Jt]:i.LINEAR,[Eo]:i.LINEAR_MIPMAP_NEAREST,[Yn]:i.LINEAR_MIPMAP_LINEAR},_e={[P_]:i.NEVER,[O_]:i.ALWAYS,[L_]:i.LESS,[_d]:i.LEQUAL,[I_]:i.EQUAL,[U_]:i.GEQUAL,[D_]:i.GREATER,[N_]:i.NOTEQUAL};function ye(y,_){if(_.type===mn&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===Jt||_.magFilter===Eo||_.magFilter===ms||_.magFilter===Yn||_.minFilter===Jt||_.minFilter===Eo||_.minFilter===ms||_.minFilter===Yn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(y,i.TEXTURE_WRAP_S,j[_.wrapS]),i.texParameteri(y,i.TEXTURE_WRAP_T,j[_.wrapT]),(y===i.TEXTURE_3D||y===i.TEXTURE_2D_ARRAY)&&i.texParameteri(y,i.TEXTURE_WRAP_R,j[_.wrapR]),i.texParameteri(y,i.TEXTURE_MAG_FILTER,de[_.magFilter]),i.texParameteri(y,i.TEXTURE_MIN_FILTER,de[_.minFilter]),_.compareFunction&&(i.texParameteri(y,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(y,i.TEXTURE_COMPARE_FUNC,_e[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Vt||_.minFilter!==ms&&_.minFilter!==Yn||_.type===mn&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const C=e.get("EXT_texture_filter_anisotropic");i.texParameterf(y,C.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function Be(y,_){let C=!1;y.__webglInit===void 0&&(y.__webglInit=!0,_.addEventListener("dispose",U));const X=_.source;let G=h.get(X);G===void 0&&(G={},h.set(X,G));const k=H(_);if(k!==y.__cacheKey){G[k]===void 0&&(G[k]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,C=!0),G[k].usedTimes++;const le=G[y.__cacheKey];le!==void 0&&(G[y.__cacheKey].usedTimes--,le.usedTimes===0&&F(_)),y.__cacheKey=k,y.__webglTexture=G[k].texture}return C}function Ge(y,_,C){let X=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(X=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(X=i.TEXTURE_3D);const G=Be(y,_),k=_.source;t.bindTexture(X,y.__webglTexture,i.TEXTURE0+C);const le=n.get(k);if(k.version!==le.__version||G===!0){t.activeTexture(i.TEXTURE0+C);const ae=Ze.getPrimaries(Ze.workingColorSpace),ce=_.colorSpace===pi?null:Ze.getPrimaries(_.colorSpace),ve=_.colorSpace===pi||ae===ce?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ve);let oe=v(_.image,!1,r.maxTextureSize);oe=ne(_,oe);const pe=s.convert(_.format,_.colorSpace),ze=s.convert(_.type);let Re=A(_.internalFormat,pe,ze,_.colorSpace,_.isVideoTexture);ye(X,_);let xe;const Pe=_.mipmaps,be=_.isVideoTexture!==!0,Ye=le.__version===void 0||G===!0,x=k.dataReady,W=T(_,oe);if(_.isDepthTexture)Re=M(_.format===kr,_.type),Ye&&(be?t.texStorage2D(i.TEXTURE_2D,1,Re,oe.width,oe.height):t.texImage2D(i.TEXTURE_2D,0,Re,oe.width,oe.height,0,pe,ze,null));else if(_.isDataTexture)if(Pe.length>0){be&&Ye&&t.texStorage2D(i.TEXTURE_2D,W,Re,Pe[0].width,Pe[0].height);for(let Y=0,J=Pe.length;Y<J;Y++)xe=Pe[Y],be?x&&t.texSubImage2D(i.TEXTURE_2D,Y,0,0,xe.width,xe.height,pe,ze,xe.data):t.texImage2D(i.TEXTURE_2D,Y,Re,xe.width,xe.height,0,pe,ze,xe.data);_.generateMipmaps=!1}else be?(Ye&&t.texStorage2D(i.TEXTURE_2D,W,Re,oe.width,oe.height),x&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,oe.width,oe.height,pe,ze,oe.data)):t.texImage2D(i.TEXTURE_2D,0,Re,oe.width,oe.height,0,pe,ze,oe.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){be&&Ye&&t.texStorage3D(i.TEXTURE_2D_ARRAY,W,Re,Pe[0].width,Pe[0].height,oe.depth);for(let Y=0,J=Pe.length;Y<J;Y++)if(xe=Pe[Y],_.format!==sn)if(pe!==null)if(be){if(x)if(_.layerUpdates.size>0){const ue=Cf(xe.width,xe.height,_.format,_.type);for(const Ae of _.layerUpdates){const Ue=xe.data.subarray(Ae*ue/xe.data.BYTES_PER_ELEMENT,(Ae+1)*ue/xe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Y,0,0,Ae,xe.width,xe.height,1,pe,Ue,0,0)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Y,0,0,0,xe.width,xe.height,oe.depth,pe,xe.data,0,0)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Y,Re,xe.width,xe.height,oe.depth,0,xe.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else be?x&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Y,0,0,0,xe.width,xe.height,oe.depth,pe,ze,xe.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Y,Re,xe.width,xe.height,oe.depth,0,pe,ze,xe.data)}else{be&&Ye&&t.texStorage2D(i.TEXTURE_2D,W,Re,Pe[0].width,Pe[0].height);for(let Y=0,J=Pe.length;Y<J;Y++)xe=Pe[Y],_.format!==sn?pe!==null?be?x&&t.compressedTexSubImage2D(i.TEXTURE_2D,Y,0,0,xe.width,xe.height,pe,xe.data):t.compressedTexImage2D(i.TEXTURE_2D,Y,Re,xe.width,xe.height,0,xe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):be?x&&t.texSubImage2D(i.TEXTURE_2D,Y,0,0,xe.width,xe.height,pe,ze,xe.data):t.texImage2D(i.TEXTURE_2D,Y,Re,xe.width,xe.height,0,pe,ze,xe.data)}else if(_.isDataArrayTexture)if(be){if(Ye&&t.texStorage3D(i.TEXTURE_2D_ARRAY,W,Re,oe.width,oe.height,oe.depth),x)if(_.layerUpdates.size>0){const Y=Cf(oe.width,oe.height,_.format,_.type);for(const J of _.layerUpdates){const ue=oe.data.subarray(J*Y/oe.data.BYTES_PER_ELEMENT,(J+1)*Y/oe.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,J,oe.width,oe.height,1,pe,ze,ue)}_.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,oe.width,oe.height,oe.depth,pe,ze,oe.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Re,oe.width,oe.height,oe.depth,0,pe,ze,oe.data);else if(_.isData3DTexture)be?(Ye&&t.texStorage3D(i.TEXTURE_3D,W,Re,oe.width,oe.height,oe.depth),x&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,oe.width,oe.height,oe.depth,pe,ze,oe.data)):t.texImage3D(i.TEXTURE_3D,0,Re,oe.width,oe.height,oe.depth,0,pe,ze,oe.data);else if(_.isFramebufferTexture){if(Ye)if(be)t.texStorage2D(i.TEXTURE_2D,W,Re,oe.width,oe.height);else{let Y=oe.width,J=oe.height;for(let ue=0;ue<W;ue++)t.texImage2D(i.TEXTURE_2D,ue,Re,Y,J,0,pe,ze,null),Y>>=1,J>>=1}}else if(Pe.length>0){if(be&&Ye){const Y=se(Pe[0]);t.texStorage2D(i.TEXTURE_2D,W,Re,Y.width,Y.height)}for(let Y=0,J=Pe.length;Y<J;Y++)xe=Pe[Y],be?x&&t.texSubImage2D(i.TEXTURE_2D,Y,0,0,pe,ze,xe):t.texImage2D(i.TEXTURE_2D,Y,Re,pe,ze,xe);_.generateMipmaps=!1}else if(be){if(Ye){const Y=se(oe);t.texStorage2D(i.TEXTURE_2D,W,Re,Y.width,Y.height)}x&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,pe,ze,oe)}else t.texImage2D(i.TEXTURE_2D,0,Re,pe,ze,oe);m(_)&&p(X),le.__version=k.version,_.onUpdate&&_.onUpdate(_)}y.__version=_.version}function re(y,_,C){if(_.image.length!==6)return;const X=Be(y,_),G=_.source;t.bindTexture(i.TEXTURE_CUBE_MAP,y.__webglTexture,i.TEXTURE0+C);const k=n.get(G);if(G.version!==k.__version||X===!0){t.activeTexture(i.TEXTURE0+C);const le=Ze.getPrimaries(Ze.workingColorSpace),ae=_.colorSpace===pi?null:Ze.getPrimaries(_.colorSpace),ce=_.colorSpace===pi||le===ae?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ce);const ve=_.isCompressedTexture||_.image[0].isCompressedTexture,oe=_.image[0]&&_.image[0].isDataTexture,pe=[];for(let J=0;J<6;J++)!ve&&!oe?pe[J]=v(_.image[J],!0,r.maxCubemapSize):pe[J]=oe?_.image[J].image:_.image[J],pe[J]=ne(_,pe[J]);const ze=pe[0],Re=s.convert(_.format,_.colorSpace),xe=s.convert(_.type),Pe=A(_.internalFormat,Re,xe,_.colorSpace),be=_.isVideoTexture!==!0,Ye=k.__version===void 0||X===!0,x=G.dataReady;let W=T(_,ze);ye(i.TEXTURE_CUBE_MAP,_);let Y;if(ve){be&&Ye&&t.texStorage2D(i.TEXTURE_CUBE_MAP,W,Pe,ze.width,ze.height);for(let J=0;J<6;J++){Y=pe[J].mipmaps;for(let ue=0;ue<Y.length;ue++){const Ae=Y[ue];_.format!==sn?Re!==null?be?x&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,ue,0,0,Ae.width,Ae.height,Re,Ae.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,ue,Pe,Ae.width,Ae.height,0,Ae.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):be?x&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,ue,0,0,Ae.width,Ae.height,Re,xe,Ae.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,ue,Pe,Ae.width,Ae.height,0,Re,xe,Ae.data)}}}else{if(Y=_.mipmaps,be&&Ye){Y.length>0&&W++;const J=se(pe[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,W,Pe,J.width,J.height)}for(let J=0;J<6;J++)if(oe){be?x&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,pe[J].width,pe[J].height,Re,xe,pe[J].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Pe,pe[J].width,pe[J].height,0,Re,xe,pe[J].data);for(let ue=0;ue<Y.length;ue++){const Ue=Y[ue].image[J].image;be?x&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,ue+1,0,0,Ue.width,Ue.height,Re,xe,Ue.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,ue+1,Pe,Ue.width,Ue.height,0,Re,xe,Ue.data)}}else{be?x&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,Re,xe,pe[J]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Pe,Re,xe,pe[J]);for(let ue=0;ue<Y.length;ue++){const Ae=Y[ue];be?x&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,ue+1,0,0,Re,xe,Ae.image[J]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,ue+1,Pe,Re,xe,Ae.image[J])}}}m(_)&&p(i.TEXTURE_CUBE_MAP),k.__version=G.version,_.onUpdate&&_.onUpdate(_)}y.__version=_.version}function fe(y,_,C,X,G,k){const le=s.convert(C.format,C.colorSpace),ae=s.convert(C.type),ce=A(C.internalFormat,le,ae,C.colorSpace);if(!n.get(_).__hasExternalTextures){const oe=Math.max(1,_.width>>k),pe=Math.max(1,_.height>>k);G===i.TEXTURE_3D||G===i.TEXTURE_2D_ARRAY?t.texImage3D(G,k,ce,oe,pe,_.depth,0,le,ae,null):t.texImage2D(G,k,ce,oe,pe,0,le,ae,null)}t.bindFramebuffer(i.FRAMEBUFFER,y),z(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,X,G,n.get(C).__webglTexture,0,V(_)):(G===i.TEXTURE_2D||G>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&G<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,X,G,n.get(C).__webglTexture,k),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Se(y,_,C){if(i.bindRenderbuffer(i.RENDERBUFFER,y),_.depthBuffer){const X=_.depthTexture,G=X&&X.isDepthTexture?X.type:null,k=M(_.stencilBuffer,G),le=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ae=V(_);z(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ae,k,_.width,_.height):C?i.renderbufferStorageMultisample(i.RENDERBUFFER,ae,k,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,k,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,le,i.RENDERBUFFER,y)}else{const X=_.textures;for(let G=0;G<X.length;G++){const k=X[G],le=s.convert(k.format,k.colorSpace),ae=s.convert(k.type),ce=A(k.internalFormat,le,ae,k.colorSpace),ve=V(_);C&&z(_)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,ve,ce,_.width,_.height):z(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ve,ce,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,ce,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function me(y,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,y),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(_.depthTexture).__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),ee(_.depthTexture,0);const X=n.get(_.depthTexture).__webglTexture,G=V(_);if(_.depthTexture.format===Cr)z(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,X,0,G):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,X,0);else if(_.depthTexture.format===kr)z(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,X,0,G):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,X,0);else throw new Error("Unknown depthTexture format")}function Le(y){const _=n.get(y),C=y.isWebGLCubeRenderTarget===!0;if(y.depthTexture&&!_.__autoAllocateDepthBuffer){if(C)throw new Error("target.depthTexture not supported in Cube render targets");me(_.__webglFramebuffer,y)}else if(C){_.__webglDepthbuffer=[];for(let X=0;X<6;X++)t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[X]),_.__webglDepthbuffer[X]=i.createRenderbuffer(),Se(_.__webglDepthbuffer[X],y,!1)}else t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer=i.createRenderbuffer(),Se(_.__webglDepthbuffer,y,!1);t.bindFramebuffer(i.FRAMEBUFFER,null)}function Fe(y,_,C){const X=n.get(y);_!==void 0&&fe(X.__webglFramebuffer,y,y.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),C!==void 0&&Le(y)}function Ne(y){const _=y.texture,C=n.get(y),X=n.get(_);y.addEventListener("dispose",P);const G=y.textures,k=y.isWebGLCubeRenderTarget===!0,le=G.length>1;if(le||(X.__webglTexture===void 0&&(X.__webglTexture=i.createTexture()),X.__version=_.version,o.memory.textures++),k){C.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(_.mipmaps&&_.mipmaps.length>0){C.__webglFramebuffer[ae]=[];for(let ce=0;ce<_.mipmaps.length;ce++)C.__webglFramebuffer[ae][ce]=i.createFramebuffer()}else C.__webglFramebuffer[ae]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){C.__webglFramebuffer=[];for(let ae=0;ae<_.mipmaps.length;ae++)C.__webglFramebuffer[ae]=i.createFramebuffer()}else C.__webglFramebuffer=i.createFramebuffer();if(le)for(let ae=0,ce=G.length;ae<ce;ae++){const ve=n.get(G[ae]);ve.__webglTexture===void 0&&(ve.__webglTexture=i.createTexture(),o.memory.textures++)}if(y.samples>0&&z(y)===!1){C.__webglMultisampledFramebuffer=i.createFramebuffer(),C.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,C.__webglMultisampledFramebuffer);for(let ae=0;ae<G.length;ae++){const ce=G[ae];C.__webglColorRenderbuffer[ae]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,C.__webglColorRenderbuffer[ae]);const ve=s.convert(ce.format,ce.colorSpace),oe=s.convert(ce.type),pe=A(ce.internalFormat,ve,oe,ce.colorSpace,y.isXRRenderTarget===!0),ze=V(y);i.renderbufferStorageMultisample(i.RENDERBUFFER,ze,pe,y.width,y.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ae,i.RENDERBUFFER,C.__webglColorRenderbuffer[ae])}i.bindRenderbuffer(i.RENDERBUFFER,null),y.depthBuffer&&(C.__webglDepthRenderbuffer=i.createRenderbuffer(),Se(C.__webglDepthRenderbuffer,y,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(k){t.bindTexture(i.TEXTURE_CUBE_MAP,X.__webglTexture),ye(i.TEXTURE_CUBE_MAP,_);for(let ae=0;ae<6;ae++)if(_.mipmaps&&_.mipmaps.length>0)for(let ce=0;ce<_.mipmaps.length;ce++)fe(C.__webglFramebuffer[ae][ce],y,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,ce);else fe(C.__webglFramebuffer[ae],y,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);m(_)&&p(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(le){for(let ae=0,ce=G.length;ae<ce;ae++){const ve=G[ae],oe=n.get(ve);t.bindTexture(i.TEXTURE_2D,oe.__webglTexture),ye(i.TEXTURE_2D,ve),fe(C.__webglFramebuffer,y,ve,i.COLOR_ATTACHMENT0+ae,i.TEXTURE_2D,0),m(ve)&&p(i.TEXTURE_2D)}t.unbindTexture()}else{let ae=i.TEXTURE_2D;if((y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(ae=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ae,X.__webglTexture),ye(ae,_),_.mipmaps&&_.mipmaps.length>0)for(let ce=0;ce<_.mipmaps.length;ce++)fe(C.__webglFramebuffer[ce],y,_,i.COLOR_ATTACHMENT0,ae,ce);else fe(C.__webglFramebuffer,y,_,i.COLOR_ATTACHMENT0,ae,0);m(_)&&p(ae),t.unbindTexture()}y.depthBuffer&&Le(y)}function nt(y){const _=y.textures;for(let C=0,X=_.length;C<X;C++){const G=_[C];if(m(G)){const k=y.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,le=n.get(G).__webglTexture;t.bindTexture(k,le),p(k),t.unbindTexture()}}}const L=[],R=[];function I(y){if(y.samples>0){if(z(y)===!1){const _=y.textures,C=y.width,X=y.height;let G=i.COLOR_BUFFER_BIT;const k=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,le=n.get(y),ae=_.length>1;if(ae)for(let ce=0;ce<_.length;ce++)t.bindFramebuffer(i.FRAMEBUFFER,le.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,le.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,le.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,le.__webglFramebuffer);for(let ce=0;ce<_.length;ce++){if(y.resolveDepthBuffer&&(y.depthBuffer&&(G|=i.DEPTH_BUFFER_BIT),y.stencilBuffer&&y.resolveStencilBuffer&&(G|=i.STENCIL_BUFFER_BIT)),ae){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,le.__webglColorRenderbuffer[ce]);const ve=n.get(_[ce]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ve,0)}i.blitFramebuffer(0,0,C,X,0,0,C,X,G,i.NEAREST),l===!0&&(L.length=0,R.length=0,L.push(i.COLOR_ATTACHMENT0+ce),y.depthBuffer&&y.resolveDepthBuffer===!1&&(L.push(k),R.push(k),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,R)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,L))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ae)for(let ce=0;ce<_.length;ce++){t.bindFramebuffer(i.FRAMEBUFFER,le.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.RENDERBUFFER,le.__webglColorRenderbuffer[ce]);const ve=n.get(_[ce]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,le.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.TEXTURE_2D,ve,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,le.__webglMultisampledFramebuffer)}else if(y.depthBuffer&&y.resolveDepthBuffer===!1&&l){const _=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function V(y){return Math.min(r.maxSamples,y.samples)}function z(y){const _=n.get(y);return y.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function ie(y){const _=o.render.frame;u.get(y)!==_&&(u.set(y,_),y.update())}function ne(y,_){const C=y.colorSpace,X=y.format,G=y.type;return y.isCompressedTexture===!0||y.isVideoTexture===!0||C!==Ct&&C!==pi&&(Ze.getTransfer(C)===lt?(X!==sn||G!==Qn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",C)),_}function se(y){return typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement?(c.width=y.naturalWidth||y.width,c.height=y.naturalHeight||y.height):typeof VideoFrame<"u"&&y instanceof VideoFrame?(c.width=y.displayWidth,c.height=y.displayHeight):(c.width=y.width,c.height=y.height),c}this.allocateTextureUnit=q,this.resetTextureUnits=D,this.setTexture2D=ee,this.setTexture2DArray=te,this.setTexture3D=Z,this.setTextureCube=Q,this.rebindTextures=Fe,this.setupRenderTarget=Ne,this.updateRenderTargetMipmap=nt,this.updateMultisampleRenderTarget=I,this.setupDepthRenderbuffer=Le,this.setupFrameBufferTexture=fe,this.useMultisampledRTT=z}function Qy(i,e){function t(n,r=pi){let s;const o=Ze.getTransfer(r);if(n===Qn)return i.UNSIGNED_BYTE;if(n===Rc)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Cc)return i.UNSIGNED_SHORT_5_5_5_1;if(n===ld)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===od)return i.BYTE;if(n===ad)return i.SHORT;if(n===Cs)return i.UNSIGNED_SHORT;if(n===wc)return i.INT;if(n===ji)return i.UNSIGNED_INT;if(n===mn)return i.FLOAT;if(n===Ns)return i.HALF_FLOAT;if(n===cd)return i.ALPHA;if(n===ud)return i.RGB;if(n===sn)return i.RGBA;if(n===fd)return i.LUMINANCE;if(n===hd)return i.LUMINANCE_ALPHA;if(n===Cr)return i.DEPTH_COMPONENT;if(n===kr)return i.DEPTH_STENCIL;if(n===Pc)return i.RED;if(n===Lc)return i.RED_INTEGER;if(n===dd)return i.RG;if(n===Ic)return i.RG_INTEGER;if(n===Dc)return i.RGBA_INTEGER;if(n===To||n===bo||n===Ao||n===wo)if(o===lt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===To)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===bo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Ao)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===wo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===To)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===bo)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Ao)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===wo)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===El||n===Tl||n===bl||n===Al)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===El)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Tl)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===bl)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Al)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===wl||n===Rl||n===Cl)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===wl||n===Rl)return o===lt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Cl)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Pl||n===Ll||n===Il||n===Dl||n===Nl||n===Ul||n===Ol||n===Fl||n===Bl||n===zl||n===kl||n===Hl||n===Vl||n===Gl)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Pl)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ll)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Il)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Dl)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Nl)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ul)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ol)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Fl)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Bl)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===zl)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===kl)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Hl)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Vl)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Gl)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ro||n===Wl||n===Xl)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Ro)return o===lt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Wl)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Xl)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===pd||n===jl||n===ql||n===Yl)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===Ro)return s.COMPRESSED_RED_RGTC1_EXT;if(n===jl)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ql)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Yl)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===zr?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class eS extends kt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Vi extends ut{constructor(){super(),this.isGroup=!0,this.type="Group"}}const tS={type:"move"};class $a{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Vi,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Vi,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new N,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new N),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Vi,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new N,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new N),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const v of e.hand.values()){const m=t.getJointPose(v,n),p=this._getHandJoint(c,v);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],h=u.position.distanceTo(f.position),d=.02,g=.005;c.inputState.pinching&&h>d+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&h<=d-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=t.getPose(e.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(tS)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Vi;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const nS=`
void main() {
